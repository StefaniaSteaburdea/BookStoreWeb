...
<ul>
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="#">Literatura Romană</a>
      <a href="index2.php" accesskey="5">Literatura Universală</a>
    </div>
	<li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn"><b>Culegeri și manuale</b></a>
    <div class="dropdown-content">
      <a href="index3.php" >Ciclul primar</a>
      <a href="index4.php" accesskey="5">Gimnaziu</a>
      <a href="index5.php" accesskey="5">Liceu</a>
    </div>
	<li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn"><b>Cărți pentru copii</b></a>
    <div class="dropdown-content">
      <a href="index6.php" accesskey="5">Cărți de colorat</a>
      <a href="index7.php" accesskey="5">Basme</a>
      <a href="index8.php" accesskey="5">Povestiri</a>
    </div>
  </li>
</ul>
</div>
      ...
      <?php
           $con = mysql_connect("localhost", "SSteaburdea", " ");
            if (!$con) {
             ...
             $sql="SELECT * FROM carti WHERE gen='ro'";
             $qr= mysql_query($sql);
