...
<ul>
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="index.php" accesskey="5">Literatura Romană</a>
      <a href="#">Literatura Universală</a>
    </div>
	<li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn"><b>Culegeri și manuale</b></a>
    <div class="dropdown-content">
      <a href="index3.php" accesskey="5">Ciclul primar</a>
    ...
    <div class="dropdown-content">
      <a href="index6.php">Cărți de colorat</a>
      ...
      <?php
           $con = mysql_connect("localhost", "SSteaburdea", " ");
            if (!$con) {
             ...
             $sql="SELECT * FROM carti WHERE gen='univ'";
             $qr= mysql_query($sql);
             $ct=0;
